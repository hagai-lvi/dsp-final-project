...
public class Step1MapperTest {
	...
	public void mapWithMultipleMatches() throws Exception {
		...
		mapDriver.withOutput(new Text("gold/NN pobj in/IN prep abounded/NN"), new LongWritable(23));
		mapDriver.withOutput(new Text("silver/NN conj gold/NN pobj in/IN prep abounded/NN"), new LongWritable(23));
		mapDriver.withOutput(new Text("silver/NN conj gold/NN"), new LongWritable(23));
		mapDriver.runTest();
	}
